    ...
    <div class="flex h-screen">
        ...
        <div id="Content" class="w-full p-6 overflow-y-auto">
            <main class="flex flex-col ">
                <header class="flex items-center justify-between p-4 text-gray-800 bg-white rounded shadow">
                ...
                <section id="dashboard">
                    <div class="p-4 bg-white rounded shadow">
                        ...
                        <p class="mt-2 text-gray-600">Use the menu to manage posts, users, and kategori.</p>
                    </div>
                </section>
                                            ...
                                            <div x-data="{ open: false }">
                                                ...
                                                <div x-show="open" x-cloak
                                                    ...
                                                    <div @click.away="open = false"
                                                        class="relative w-full max-w-md p-6 mx-auto overflow-y-auto bg-white rounded-lg shadow-lg">
                                                        ...
                                                        <h2 class="text-2xl font-semibold text-gray-800">Tambah Quota
                                                        </h2>
